...
// 5.
create view salary_5000_12000 as
...
// a.
// do finance_employees nie można dodać rekordu ponieważ nie ma pokrycia w wymaganych kolumnach
// tabel na bazie których powstał widok
insert into finance_employees values (207, 'Andrzej', 'Kowalski');

// w salary_5000_12000 można dodać rekord ponieważ posiada w sobie wymagane kolumny
// należy jednak uważać na kolejność kolumn która różni się od tabeli bazowej
insert into salary_5000_12000
values (207, 'Andrzej', 'Kowalski', 9999, 'FI_ACCOUNT', 'AKowalski', DATE '2020-07-01');

// b.
update salary_5000_12000
set last_name = 'Kowalski',
    first_name = 'Andrzej'
where employee_id = 207;

// c.
delete from salary_5000_12000
where employee_id = 207;

// 7.
create view atleast_4_employees as
...
insert into atleast_4_employees
values (100, 'Finance', 123, 9999, 12121);

// 8.
create view salary_5000_12000_with_check as
    select employee_id, last_name, first_name, salary, job_id, email, hire_date
    from employees
    where salary between 5000 and 12000
with check option;
